...
public class GameController {
     ...
     * @param yellow Whether the image should be set to a yellow number.
     * @param number The number the image should be set to.
     */
    private static void setImage(ImageView image, boolean yellow, int number) {
        String path = String.format("/%s/%d.png",
                yellow ? "yellow" : "white", number);
